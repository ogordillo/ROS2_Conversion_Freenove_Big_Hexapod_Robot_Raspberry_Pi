import math
from control.kalman import Kalman_filter
...
class SimIMUFilter:
    ...
    def update_imu_state(self, accel_data, gyro_data):
        ...
        return {
            'orientation': {'w': self.quaternion_w, 'x': self.quaternion_x, 'y': self.quaternion_y, 'z': self.quaternion_z},
            'angular_velocity': self.latest_angular_velocity,
            'linear_acceleration': self.latest_linear_acceleration
        }
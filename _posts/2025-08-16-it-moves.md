---
layout: default
title:  "Week 2 - 🚪 Setting up WSL, ROS, Docker and first ROS Topic to move the Robot"
date:   2025-08-16
thumbnail: /assets/images/windows-command-example-script.png
---
...
<iframe
  src="https://www.youtube.com/embed/Im3h_CzNaRc"
...
Here is a screenshot of the WSL ROS node launching a command PyQt app that has a slider widget to control a servo position.
It also has a view for the upcoming depth streaming. 

![pyqt5-img]({{ '/assets/images/windows-command-example-script.png' | relative_url }})
